 ...
 */
final class Version20221109083601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE serie CHANGE resume resume VARCHAR(255) DEFAULT NULL, CHANGE duree duree TIME DEFAULT NULL, CHANGE premiereDiffusion premiereDiffusion DATE DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE serie CHANGE resume resume LONGTEXT DEFAULT NULL, CHANGE duree duree TIME DEFAULT \'NULL\', CHANGE premiereDiffusion premiereDiffusion DATE DEFAULT \'NULL\', CHANGE image image VARCHAR(255) DEFAULT \'NULL\'');
    }
}
